...
export function ProjectCard({
  ...
  return (
    ...
    >
      <Card
        className="project-card relative bg-black/80 w-xl border-b border-gray-700 shadow-lg cursor-pointer ease-in-out hover:[background:linear-gradient(135deg,var(--palette-pink)_0%,var(--palette-purple)_33%,var(--palette-blue)_66%,var(--palette-cyan)_100%)] transition-transform transition-colors duration-1000"
        style={{
        ...
        <CardContent className="flex flex-col gap-1">
          ...
          <div className="flex flex-wrap gap-3 mt-2">
            {technologies.map((tech) => (
              <div className="mr-2 flex text-md gap-2">
