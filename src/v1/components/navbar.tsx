...
import { AuroraText } from "@v1/components/ui/aurora-text"
import { ScrollProgress } from "@v1/components/ui/scroll-progress"
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <Link to="/v1" className="flex flex-col text-2xl">
              <span 
