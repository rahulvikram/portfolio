...
import { Dock, DockIcon } from "@v1/components/ui/dock"
import { SparklesText } from "@v1/components/ui/sparkles-text"
...
const Icons = {
  ...
  email: (props: IconProps) => <MailIcon color="#EA4335" {...props} />,
...
const DATA = {
  navbar: [
    { href: "/v1", icon: HomeIcon, label: "Home (this site)" },
  ],
  contact: {
    social: {
      GitHub: {
